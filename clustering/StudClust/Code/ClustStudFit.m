%x - Initial clustering solution. Vector of integers from 1 to Nclust. 
%The highest integer determines the number of clusters Nclust.
%Cluster distribution is determined by the initial solution
%Dpref - the belbin preferences (Nstud x Nroles). 

function [out, WS, BS] = ClustStudFit(x,Dpref,Dbelbin)
